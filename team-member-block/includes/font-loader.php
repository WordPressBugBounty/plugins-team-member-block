...
class EB_Team_Member_Font_Loader {
     ...
     * @access public
     */
    public function fonts_loader( $handle_name = 'eb-team-member-fonts' ) {
        $googleFont = true;
...
EB_Team_Member_Font_Loader::get_instance( 'team-member-block/team-member-block' );
